...
using DemoAppWFP.Utils.Manager;
using DemoAppWFP.Utils.Exception;
using DataLogicBAL.CMS.Exceptions;
using DemoAppWFP.DataLogicBAL.CMS.Main;
using DemoAppWFP.Utils.Logger;

namespace DemoAppWPF.Views
{
